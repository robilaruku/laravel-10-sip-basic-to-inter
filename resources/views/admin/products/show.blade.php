    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                {!! Form::model($product, ['route' => ['admin.product.show', $product->id], 'method' => 'put', 'files' => true]) !!}
                <div class="card-body">
                    <div class="row">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.product.index') }}" class="btn btn-outline-secondary"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
