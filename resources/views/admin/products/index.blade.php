        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('admin.product.create') }}" class="btn btn-tool">
                ...
                {!! Form::open(['route' => 'admin.product.index', 'method' => 'get']) !!}
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('admin.product.index') }}" class="btn btn-outline btn-secondary" style="margin-top: 6%"><i class="fas fa-sync"></i> Reload</a>
                        </div>
                    </div>
                {!! Form::close() !!}
                <br><br>
                                ...
                                <td>
                                    <form action="{{ route('admin.product.destroy', $item->id) }}" method="post">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Button group">
                                            <a href="{{ route('admin.product.show', $item->id) }}" class="btn btn-sm btn-info" style="color: #fff"><i class="fa fa-eye"></i></a>
                                            <a href="{{ route('admin.product.edit', $item->id) }}" class="btn btn-sm btn-success" style="color: #fff"><i class="fa fa-edit"></i></a>
