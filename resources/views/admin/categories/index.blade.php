        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('admin.category.create') }}" class="btn btn-tool">
                                    ...
                                    <td>
                                        <form action="{{ route('admin.category.destroy', $value->id) }}" method="post">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Button group">
                                                <a href="{{ route('admin.category.show', $value->id) }}" class="btn btn-sm btn-info" style="color: #fff"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('admin.category.edit', $value->id) }}" class="btn btn-sm btn-success" style="color: #fff"><i class="fa fa-edit"></i></a>
