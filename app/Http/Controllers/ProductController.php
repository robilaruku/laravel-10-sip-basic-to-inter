...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('admin.product.create')->withErrors($validator)->withInput($request->all());
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('admin.product.edit', $id)->withErrors($validator)->withInput($request->all());
        }
